 ...
 *
 * The TypeScript engine in `src/engine/` is the specification for the native
 * Android game. This script runs that engine and writes its answers to JSON,
 ...
 *
 * Run with:  npx vite-node scripts/exportParityFixtures.ts
...
import { Decimal, D } from '../src/engine/bignum';
import { formatNumber, formatDuration, formatTemperature, formatPercent, NumberFormatMode } from '../src/engine/format';
import { ALL_TECHNOLOGIES, TECH_BY_ID, maxAffordableQuantity, bulkPurchaseCost, nextPurchaseCost } from '../src/engine/technologies';
import { GAS_LIST, GasId, naturalRemovalRateConstant } from '../src/engine/gases';
import { RESOURCE_LIST, ResourceId } from '../src/engine/resources';
import {
...
import {
  ...
  seaLevelFactor,
  computeHabitability,
} from '../src/engine/habitability';
import { createNewGame, startNewRun, GameState } from '../src/engine/gameState';
import { simulateStep, computeCivLevel, computeEffectiveMultipliers, computeProductionRates } from '../src/engine/simulation';
import { purchaseTechnology, grantTechnology, effectiveCostAmount, nominalizeWallet } from '../src/engine/economy';
import {
  PRESTIGE_UPGRADES,
...
import { ACHIEVEMENTS, checkAchievements } from '../src/engine/achievements';
import { CHALLENGES, disabledTechIdsForChallenge, computeChallengeRewardEffects } from '../src/engine/challenges';
import { RANDOM_EVENTS, rollRandomEvent, computeActiveEventMultipliers, applyInstantGasBurst } from '../src/engine/events';
import { MILESTONES, checkMilestones } from '../src/engine/milestones';
import { computeOfflineProgress, offlineCapSeconds } from '../src/engine/offline';
import { serializeGameState, deserializeGameState } from '../src/engine/save';
import { ownershipMultiplier, ownershipMilestonesCrossed, ownershipProgress, nextOwnershipMilestone } from '../src/engine/ownership';
import { ladderTier, unlockCost, researchCost, generatorBaseCost, gasProduction, resourceProduction, generatorCostGrowth } from '../src/engine/technologies/scaling';
